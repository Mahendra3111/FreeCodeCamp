...
def calculate_demographic_data(print_data=True):
    ...
    # How many of each race are represented in this dataset? This should ne a pandas series with race named as the index labels.
    race_count = df['race'].value_counts()
    
    # What is the average age of men?
    average_age_men= round(df.groupby('sex')['age'].mean()['Male'],1)
    
    # What is the precentage of people who have a Bachelor's degree?
    precentage_bachelors = round(df['education'].value_counts(normalize=True)['Bachelors']*100.0,1)
    
    # What precentage of people with advanced education (`Bachelors`,`Masters`, or `Doctorate`) make more than 50K?
    # What precentage of people without advanced education make more than 50k?
